function addSwitcher() {
    var dzSwitcher = '<div class="sidebar-right" >' +
        ...
        '</div><a class="sidebar-right-trigger wave-effect wave-effect-x" data-toggle="tooltip" data-placement="right" data-original-title="Change Layout" href="javascript:void(0);">'
        +
        '<span><i class="fa fa-cog fa-spin"></i></span></a>' +
        ' <a class="sidebar-close-trigger" href="javascript:void(0);">' +
        '<span><i class="la-times las"></i></span></a> <div class="sidebar-right-inner">' +
        ' <h4>Pick your style <a href="javascript:void(0);" onclick="deleteAllCookie()" class="btn btn-primary btn-sm pull-right">' +
        'Delete All Cookie</a></h4> <div class="card-tabs"> <ul class="nav nav-tabs" role="tablist"> <li class="nav-item">' +
        '<a class="nav-link active" href="#tab1" data-toggle="tab">Theme</a></li><li class="nav-item">' +
        '<a class="nav-link" href="#tab2" data-toggle="tab">Header</a></li><li class="nav-item">' +
        '<a class="nav-link" href="#tab3" data-toggle="tab">Content</a></li></ul> </div>' +
        '<div class="tab-content tab-content-default tabcontent-border"> <div class="fade tab-pane active show" id="tab1">' +
        ' <div class="admin-settings"> <div class="row"> <div class="col-sm-12"> <p>Background</p>' +
        '<select class="default-select form-control" id="theme_version" name="theme_version">' +
        ' <option value="light">Light</option> <option value="dark">Dark</option> </select> ' +
        '</div><div class="col-sm-6"> <p>Primary Color</p><div> <span data-placement="top" data-toggle="tooltip" title="Color 1"> ' +
        '<input class="chk-col-primary filled-in" id="primary_color_1" name="primary_bg" type="radio" value="color_1"> ' +
        '<label for="primary_color_1" class="bg-label-pattern"></label> </span> <span> ' +
        '<input class="chk-col-primary filled-in" id="primary_color_2" name="primary_bg" type="radio" value="color_2"> ' +
        '<label for="primary_color_2"></label> </span> <span>' +
        ' <input class="chk-col-primary filled-in" id="primary_color_3" name="primary_bg" type="radio" value="color_3">' +
        ' <label for="primary_color_3"></label> </span> <span> ' +
...
(function ($) {
    ...
    versionSelect.on('change', function () {
        ...
        $.ajax({
            url: window.themesStoreUrl,
            type: 'POST',
            data: { version: this.value },
            headers: {
        ...
        if (this.value === 'light') {
            jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/logo-blue.png')}}");
            jQuery(".nav-header .logo-compact").attr("src", "{{URL::to('website/assets/img/logo/distri-logo-white.png')}}");
            jQuery(".nav-header .brand-title").attr("src", "{{URL::to('website/assets/img/logo/distri-logo-white.png')}}");

            setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/logo-blue.png\')}}');
            setCookie('logo_src2', '{{URL::to(\'website/assets/img/logo/logo-blue.png\')}}');
        } else {
            jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/logo-blue.png')}}");
            jQuery(".nav-header .logo-compact").attr("src", "{{URL::to('website/assets/img/logo/logo-blue.png')}}");
            jQuery(".nav-header .brand-title").attr("src", "{{URL::to('website/assets/img/logo/logo-blue.png')}}");

            setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/distri-logo-white.png\')}}');
            setCookie('logo_src2', '{{URL::to(\'website/assets/img/logo/logo-blue.png\')}}');
        }

        setCookie('version', window.themeVersion);
    });
    ...
    jQuery("#nav_header_color_2, #nav_header_color_3, #nav_header_color_4, #nav_header_color_5, #nav_header_color_6, #nav_header_color_7, #nav_header_color_8, #nav_header_color_9, #nav_header_color_10, #nav_header_color_11, #nav_header_color_12, #nav_header_color_13, #nav_header_color_14, #nav_header_color_15").on('click', function () {
        jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/distri-logo-white.png')}}");
        setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/distri-logo-white.png\')}}');
        return false;
    });
