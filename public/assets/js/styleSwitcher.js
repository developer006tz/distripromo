...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/logo.png')}}");
			jQuery(".nav-header .logo-compact").attr("src", "{{URL::to('website/assets/img/logo/logo-white.png')}}");
			jQuery(".nav-header .brand-title").attr("src", "{{URL::to('website/assets/img/logo/logo-white.png')}}");

			setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/logo.png\')}}');
			setCookie('logo_src2', '{{URL::to(\'website/assets/img/logo/logo.png\')}}');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/logo.png')}}");
			jQuery(".nav-header .logo-compact").attr("src", "{{URL::to('website/assets/img/logo/logo.png')}}");
			jQuery(".nav-header .brand-title").attr("src", "{{URL::to('website/assets/img/logo/logo.png')}}");

			setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/logo-white.png\')}}');
			setCookie('logo_src2', '{{URL::to(\'website/assets/img/logo/logo.png\')}}');
		}
	...
	jQuery("#nav_header_color_2, #nav_header_color_3, #nav_header_color_4, #nav_header_color_5, #nav_header_color_6, #nav_header_color_7, #nav_header_color_8, #nav_header_color_9, #nav_header_color_10, #nav_header_color_11, #nav_header_color_12, #nav_header_color_13, #nav_header_color_14, #nav_header_color_15").on('click',function(){
		jQuery(".nav-header .logo-abbr").attr("src", "{{URL::to('website/assets/img/logo/logo-white.png')}}");
		setCookie('logo_src', '{{URL::to(\'website/assets/img/logo/logo-white.png\')}}');
		return false;
    });
