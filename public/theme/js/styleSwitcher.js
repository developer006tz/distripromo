...
(function ($) {
    ...
    versionSelect.on('change', function () {
        ...
        /* if(this.value === 'dark'){
            //jQuery(".nav-header .logo-abbr").attr("src", "./images/distri-logo-white.png");
