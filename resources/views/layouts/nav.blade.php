                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar">
                                {{str_replace(['.index','.create','.edit','.show','-'],' ', Str::ucfirst(request()->route()->getName())) == 'Home' ? 'Dashboard' : str_replace(['.index','.create','.edit','.show','-'],' ', Str::ucfirst(request()->route()->getName()))}}
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link " href="javascript:void(0);" data-bs-toggle="dropdown">
									...
									<span class="badge light text-white bg-success rounded-circle">2</span>
                                </a>
								<div class="dropdown-menu dropdown-menu-end">
